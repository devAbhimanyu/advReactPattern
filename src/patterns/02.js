...
const MediumClap = () => {
  ...
  return (
    ...
    >
      ...
      <ClapTotal countTotal={totalCount} setRef={setRef} />
    </button>
  );
};
...
const ClapCount = ({ count, setRef }) => {
  return (
    <span ref={setRef} data-refkey="refClapCount" className={styles.count}>
      + {count}
    </span>
  );
};
const ClapTotal = ({ countTotal, setRef }) => {
  return (
    <span ref={setRef} data-refkey="refClapTotal" className={styles.total}>
      {countTotal}
    </span>
  );
};
